...
class PolicyNet(object):
    ...
    def predict(self, s, ava):
        return self.sess.run(self.a, {self.s: s, self.ava: ava})[0]

    def fit(self, s, ava, a_acted, G):
        self.sess.run(self.train_op, {self.s: s, self.ava: ava, self.a_acted: a_acted, self.G: G})
        return
